...
/**
 * This class used the measurements of the wheel radius, track length and tacho meter readings to
...
public class Odometer extends OdometerData implements Runnable {
  ...
  /**
   * This method runs the main odometer logic. The odometer uses the wheel radius, track length, and
   * tacho meter measurements to update the X and Y values as well the angle Theta of the cart's
   * current position.
   */
  ...
  public void run() {
    ...
    while (true) {
      ...
      double deltaX = deltaD * Math.sin(Math.toRadians(position[2] + deltaT)); // Update
                                                                               // temporary
                                                                               // version of X
      double deltaY = deltaD * Math.cos(Math.toRadians(position[2] + deltaT)); // Update
                                                                               // temporary
                                                                               // version of Y
